        ...
        <div class="container header-inner">
            ...
            <nav class="main-nav">
                <?php if (\App\Core\Session::get('user_id')): ?>
                    ...
                    <a href="/dateapp/discover" class="nav-link" title="Discover">
                    ...
                    <a href="/dateapp/matches" class="nav-link nav-badge-wrap" title="Matches">
                        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg>
                        <?php if ($unreadCount > 0): ?>
                            <span class="nav-badge"><?= $unreadCount ?></span>
                        <?php endif; ?>
                    </a>
                    <a href="/dateapp/profile" class="nav-link" title="Profile">
                        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
                    </a>
                    <a href="/dateapp/settings" class="nav-link" title="Settings">
                    ...
                    <form method="POST" action="/dateapp/logout" class="inline-form">
                        <?= \App\Core\CSRF::field() ?>
                        <button type="submit" class="nav-link nav-logout" title="Logout">
